...
public class MSKAnimatedLabel: SKNode {
    ...
    public init(text: String, horizontalAlignment: SKLabelHorizontalAlignmentMode = .center, durationPerCharacter: Double = 0.05, fontSize: CGFloat = 12, marginVertical: CGFloat = 15.0, fontColor: SKColor = .white, fontName: String = "SF Pro Rounded Semibold", skipSpaces: Bool = true, labelWidth: CGFloat = 0.0, finishTypingOnTouch: Bool = false) {
